/* ============================================================================
   CORE
   ----------------------------------------------------------------------------
   Everything the seven designs share:
...
(function(){
  ...
  /* ------------------------------------------------------------------------
     ...
     Change to any id below: board, jobcard, index, blocks, splitdesk, clay, neu
     ------------------------------------------------------------------------ */
  ...
  var ORDER = ['board','jobcard','index','blocks','splitdesk','clay','neu'];
